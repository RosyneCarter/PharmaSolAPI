                            ...
                            <table class="table table-striped dataex-html5-selectors" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @can('manage-user')
                                        <td>
                                        <a href = "{{ route('/text.edit', $produit->id) }}"><button style="font-size: 10px" class = "btn btn-success" title="Editer"><i class="fa fa-pencil"></i></button></a>
                                        <form action="{{ route('/text.destroy', $produit->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button style="font-size: 10px" type="submit" style="font-size: 10px" class="btn btn-danger"style="font-size: 10px" title="supprimer"><i class="feather icon-trash" style="font-size: 10px" aria-hidden="true"></i></button>
                                        </form>    
                                        </div>
                                        @endcan
                                        </td>
